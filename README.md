...
After forking the repo, you should now be viewing this README in your own github org (e.g. `https://github.com/<your-org>/sample-swift`)
...
1. Under Repository, choose this repository (e.g. `<your-org>/sample-swift`)
...
1. Navigate to the sample-swift app
